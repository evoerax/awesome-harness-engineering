...
**Assume:** Skilled developer, but knows almost nothing about your toolset or problem domain. Doesn't know good test design very well.
...
**1. Spec coverage:** Skim each section/requirement. Can you point to a task that implements it? List any gaps.
